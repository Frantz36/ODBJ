...
//            desttype = typeTranslation.get(f.desc);
            if (desttype != null) {
    ...
    static String parseMethodDesc(String name, String desc, boolean trace) {
        ...
        for (Type t : args) {
            ...
            if (desttype != null) {
                ...
                if (trace) System.out.println("METHOD ("+name+"): arg["+i+"]["+Type.getType(desttype)+"]");
            } else
                newargs.add(t);
            i++;
        }
        ...
        static void parseLocalVariables(MethodNode m) {
            ...
            for (LocalVariableNode lv : list) {
                String desttype = null;
//                desttype = typeTranslation.get(lv.desc);
                if (desttype != null) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (MethodNode m : cn.methods) {
                ...
                if (m.name.equals("<clinit>")) addCreateTable(m);
