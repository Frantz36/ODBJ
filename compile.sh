...
SRC_DIR=/home/sepia/Documents/ODBjv/src/pack

# Répertoire des fichiers odbj
SRC_DIR_ODBJ=/home/sepia/Documents/ODBjv/src/odbj

# Répertoire des fichiers app 
SRC_DIR_APP=/home/sepia/Documents/ODBjv/src/app

# Répertoire de destination des .class
DEST_DIR=/home/sepia/Documents/ODBjv/bin

# Répertoire de destination des .class d'odbj 
DEST_DIR_ODBJ=/home/sepia/Documents/ODBjv/bin/odbj

# Répertoire de destination des .class d'odbj 

DEST_DIR_APP=/home/sepia/Documents/ODBjv/bin/app



# Compilation des fichiers Java
javac -cp $ASM_JARS -d $DEST_DIR $SRC_DIR/TryCatchBlockNodeStruct.java \
                                      $SRC_DIR/Inst.java \
...
javac --release 17 -d $DEST_DIR $SRC_DIR_ODBJ/Downloader.java \
...
javac -g  -d $DEST_DIR $SRC_DIR_APP/Server.java
