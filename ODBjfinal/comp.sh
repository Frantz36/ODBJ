...
cd /home/dan/Documents/ODBJ-Tomcat/servlet-mod-is/ODBjfinal/bin
#rm -rf out
#mkdir out
echo 1
java -cp $ASM_JARS:. pack.CodeParserExceptions app.IntermodServer
echo 2
cp -r pack out
cp -r odbj out
#rm -rf out/app
mkdir -p out/app
cp out/IntermodServer.class out/app/
cd -
echo "---------------"
